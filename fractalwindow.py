...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayoutWidget.setGeometry(QtCore.QRect(40, 250, 380, 120))
        ...
        self.draw_fractal_button.setGeometry(QtCore.QRect(180, 380, 111, 51))
        font = QtGui.QFont()
    ...
    def create_fractal(self):
        ...
        if self.f_ch_rbutt.isChecked():
            save_fractal(build_fractal_ch_z(self.precision.value(), self.iterations_number.value()), self.color_schema.currentText())
        if self.sinz_cosz_rbutt.isChecked():
            save_fractal(build_fractal_sin_z_cos_z(self.precision.value(), self.iterations_number.value()), self.color_schema.currentText())
